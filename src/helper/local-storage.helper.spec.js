...
describe('LocalStorage Helper', () => {
  ...
  test(
    'Should create an item in localStorage with key and value',
    () => {
      const KEY = 'CHAVE'
      const VALUE = 'VALOR'
  ...
  test(
    'Should update an item in localStorage with key and value',
    () => {
      const KEY = 'KEY'
      const VALUE = 'VALUE'
  ...
  test(
    'Should obtain an item in localStorage from the key',
    () => {
      const KEY = 'foo'
      create(KEY, 'valor')
